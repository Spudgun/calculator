...
Creating a Calculator using the [project](https://www.theodinproject.com/lessons/foundations-calculator) from The Odin Project.
...
To view the solution, got to this webpage [here](https://spudgun.github.io/calculator/).
